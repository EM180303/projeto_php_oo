...
public function inserir($conect)
	{ 
		...
		$stmt->bind_param("ssssdsssssssii",$_POST['name'], $_POST['email'], $_POST['pass'], $_POST['nascimento'], $data, $_POST['função'] ,$_POST['cep'], $_POST['rua'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['complemento'], $_POST['numeroresi'], $_POST['telefone']);
		$stmt->execute();
	}
