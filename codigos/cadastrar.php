...
public function inserir($conect)
	{ 
		...
		$stmt->bind_param("sssddsssssssii",$_POST['name'], $_POST['email'], $_POST['pass'], $datanascimento, $data, $_POST['função'] ,$_POST['cep'], $_POST['rua'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['complemento'], $_POST['numeroresi'], $_POST['telefone']);
		$stmt->execute();
	}
